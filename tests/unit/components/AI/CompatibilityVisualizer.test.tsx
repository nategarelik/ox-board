...
import { CompatibilityVisualizer } from "@/components/AI/CompatibilityVisualizer";
...
describe("CompatibilityVisualizer", () => {
  ...
  it("should apply correct color coding for scores", () => {
    const { rerender } = render(
      <CompatibilityVisualizer compatibility={mockCompatibility} />,
    );
  ...
  it("should show frequency clash status correctly", () => {
    ...
    const { rerender } = render(
      <CompatibilityVisualizer compatibility={highClashCompatibility} />,
    );
    rerender(
      <CompatibilityVisualizer compatibility={highClashCompatibility} />,
    );
  ...
  it("should display mix points count", () => {
    ...
    render(
      <CompatibilityVisualizer compatibility={compatibilityWithMixPoints} />,
    );
