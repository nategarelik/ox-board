...
} from '../gestureStemMapper';
import { HandResult, HandLandmark } from '../../gesture/recognition';
...
describe('GestureStemMapper', () => {
  ...
  describe('Single Hand Gesture Detection', () => {
    ...
    it('should detect peace sign gesture', () => {
      ...
      const gestures = mapper.detectGestures(leftHand, null, screenWidth, screenHeight);

      const peaceGesture = gestures.find(g => g.gestureType === GestureType.PEACE_SIGN);
    ...
    it('should detect rock sign gesture', () => {
      ...
      const gestures = mapper.detectGestures(null, rightHand, screenWidth, screenHeight);

      const rockGesture = gestures.find(g => g.gestureType === GestureType.ROCK_SIGN);
    ...
    it('should detect OK sign gesture', () => {
      ...
      const okGesture = gestures.find(g => g.gestureType === GestureType.OK_SIGN);
    ...
    it('should detect call sign gesture', () => {
      ...
      const callGesture = gestures.find(g => g.gestureType === GestureType.CALL_SIGN);
    ...
    it('should detect fist gesture', () => {
      ...
      const fistGesture = gestures.find(g => g.gestureType === GestureType.FIST);
    ...
    it('should detect open palm gesture', () => {
      ...
      const palmGesture = gestures.find(g => g.gestureType === GestureType.OPEN_PALM);
    ...
    it('should detect pinch gesture', () => {
      ...
      const gestures = mapper.detectGestures(pinchHand, null, screenWidth, screenHeight);
      const pinchGesture = gestures.find(g => g.gestureType === GestureType.PINCH);
  ...
  describe('Two Hand Gesture Detection', () => {
    ...
    it('should detect crossfader gesture', () => {
      ...
      const gestures = mapper.detectGestures(leftHand, rightHand, screenWidth, screenHeight);
      const crossfaderGesture = gestures.find(g => g.gestureType === GestureType.CROSSFADER_HANDS);
    ...
    it('should detect spread hands gesture', () => {
      ...
      const gestures = mapper.detectGestures(leftHand, rightHand, screenWidth, screenHeight);
      const spreadGesture = gestures.find(g => g.gestureType === GestureType.SPREAD_HANDS);
    ...
    it('should detect clap gesture', () => {
      ...
      const gestures = mapper.detectGestures(leftHand, rightHand, screenWidth, screenHeight);
      const clapGesture = gestures.find(g => g.gestureType === GestureType.CLAP);
    ...
    it('should detect dual control gesture', () => {
      ...
      const gestures = mapper.detectGestures(leftHand, rightHand, screenWidth, screenHeight);
      const dualGesture = gestures.find(g => g.gestureType === GestureType.DUAL_CONTROL);
  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    it('should handle low confidence gestures', () => {
      ...
      const gestures = mapper.detectGestures(lowConfidenceHand, null, 1920, 1080);
