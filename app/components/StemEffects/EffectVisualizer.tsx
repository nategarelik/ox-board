      ...
      <>
        <div className="space-y-2">
          ...
          <input
            ...
            value={parameters.wetness || 0}
            onChange={(e) =>
              onParameterChange("wetness", parseFloat(e.target.value))
            }
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            value={parameters.intensity || 0}
            onChange={(e) =>
              onParameterChange("intensity", parseFloat(e.target.value))
            }
            className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
            disabled={!enabled}
          />
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.roomSize || 0}
                onChange={(e) =>
                  onParameterChange("roomSize", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  onParameterChange("decay", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.time || 0}
                onChange={(e) =>
                  onParameterChange("time", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.feedback || 0}
                onChange={(e) =>
                  onParameterChange("feedback", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.frequency || 0}
                onChange={(e) =>
                  onParameterChange("frequency", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.resonance || 0}
                onChange={(e) =>
                  onParameterChange("resonance", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.drive || 0}
                onChange={(e) =>
                  onParameterChange("drive", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.tone || 0}
                onChange={(e) =>
                  onParameterChange("tone", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.threshold || 0}
                onChange={(e) =>
                  onParameterChange("threshold", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.ratio || 0}
                onChange={(e) =>
                  onParameterChange("ratio", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  onParameterChange("rate", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={parameters.depth || 0}
                onChange={(e) =>
                  onParameterChange("depth", parseFloat(e.target.value))
                }
                className="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
                disabled={!enabled}
              />
  ...
  return (
    <div
      className={`bg-gray-800 rounded-lg p-4 border-2 transition-all duration-200 ${
        enabled
          ? `border-${getEffectColor(effect).replace("#", "")} shadow-lg`
          : "border-gray-600"
      }`}
    >
  ...
  const presets: { type: PresetType; name: string; description: string }[] = [
    {
      type: "club",
      name: "Club",
      description: "Punchy compression and subtle delay",
    },
    {
      type: "hall",
      name: "Hall",
      description: "Large reverb for spacious sound",
    },
    {
      type: "studio",
      name: "Studio",
      description: "Clean compression and subtle EQ",
    },
    {
      type: "outdoor",
      name: "Outdoor",
      description: "Enhanced mids for outdoor events",
    },
  ];
        ...
        <div className="flex space-x-2">
          ...
          <div className="bg-gray-800 rounded-lg px-3 py-2 text-xs">
            <div className="flex items-center space-x-2">
              ...
              <span
                className={`font-mono ${stemState.cpuUsage > 80 ? "text-red-400" : "text-green-400"}`}
              >
          ...
          <div className="bg-gray-800 rounded-lg px-3 py-2 text-xs">
            <div className="flex items-center space-x-2">
              ...
              <span
                className={`font-mono ${stemState.latency > 10 ? "text-red-400" : "text-green-400"}`}
              >
      ...
      <div className="mb-6">
        <EffectControl
          ...
          onParameterChange={(parameter, value) =>
            onParameterChange(selectedEffect, parameter, value)
          }
        />
      </div>
