...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    try {
      ...
      // Try to log the error if console is available
      try {
        if (
      ...
      // Last resort - set basic error state
      this.setState({
        hasError: true,
              ...
              <div className="max-w-2xl w-full ox-surface p-8 rounded-lg">
                <div className="text-center">
                  <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-ox-error/20 flex items-center justify-center">
                    <svg
                      className="w-10 h-10 text-ox-error"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <p className="text-gray-400 mb-6">
                    Something went wrong. The application encountered an
                    unexpected error.
                  </p>
            ...
            <div className="ox-surface p-6 rounded-lg">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-ox-warning/20 flex-shrink-0 flex items-center justify-center">
                  <svg
                    className="w-5 h-5 text-ox-warning"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
        ...
        default:
          return (
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-ox-error/10 border border-ox-error/30 rounded">
              <svg
                className="w-4 h-4 text-ox-error"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
    ...
    <ErrorBoundary
      ...
      fallback={
        <div className="h-full flex items-center justify-center">
          <div className="text-center">
            <svg
              className="w-16 h-16 mx-auto mb-4 text-ox-error"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <h3 className="text-xl font-display mb-2 text-ox-error">
              Camera Error
            </h3>
            <p className="text-gray-400 text-sm mb-4">
              Failed to initialize camera feed
            </p>
            <button
              onClick={() => window.location.reload()}
