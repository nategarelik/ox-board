...
describe('MixRecommendationsPanel', () => {
  ...
  it('should render mix recommendations panel', () => {
    ...
    expect(screen.getByText('2 intelligent suggestions based on harmonic and rhythmic analysis')).toBeInTheDocument();
  });
  ...
  it('should expand recommendation details when clicked', async () => {
    ...
    const firstRecommendation = screen.getByText('Track track1 → Track track2').closest('div');
  ...
  it('should call onSelectRecommendation when clicking on recommendation', () => {
    ...
    expect(mockOnSelectRecommendation).toHaveBeenCalledWith(mockRecommendations[0]);
  });
  ...
  it('should handle empty recommendations gracefully', () => {
    ...
    expect(screen.getByText('No mix recommendations available')).toBeInTheDocument();
    expect(screen.getByText('Analyze tracks to see intelligent mixing suggestions')).toBeInTheDocument();
  });
  ...
  it('should show tempo adjustment colors correctly', async () => {
    ...
    const firstRec = screen.getByText('Track track1 → Track track2').closest('div');
    ...
    fireEvent.click(firstRec!);
    const secondRec = screen.getByText('Track track1 → Track track3').closest('div');
  ...
  it('should handle recommendations without effects', async () => {
    ...
    const secondRecommendation = screen.getByText('Track track1 → Track track3').closest('div');
